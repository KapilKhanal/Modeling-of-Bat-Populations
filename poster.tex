...
\usepackage{lmodern}
\usepackage[size=custom,width=120,height=76,scale=1.0]{beamerposter}
\usetheme{gemini}
...
\begin{figure}
      \hfill
   \subfigure{\includegraphics[width = 17cm]{life-cycle}}
\hfill
\subfigure{\includegraphics[width=17cm]{bat.png}}
\hfill
...
\end{equation}
  \begin{figure}
      \hfill
\subfigure{\includegraphics[width = 17.5cm, height = 13cm]{d1d2.png}}
\hfill
\subfigure{\includegraphics[width=17.5cm,height = 11.89cm]{d3d4.png}}
\hfill
